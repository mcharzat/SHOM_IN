...
/* eslint-disable no-unused-vars */
	...
	let AutoCompleteWidget = function(inputTypeComponent, autocompleteHandler) {
	...
	let ListWidget = function(inputTypeComponent, listHandler, langSearch, settings) {
	...
	let ListWidgetNew = function(inputTypeComponent, listDatasource, langSearch) {
	...
	let URLListDatasource = function(listHandler) {
	...
	let DatesWidget = function(inputTypeComponent, datesHandler, langSearch) {
	...
	let TimeDatePickerWidget = function(inputTypeComponent, datesHandler, format, langSearch) {
		this.datesHandler = datesHandler;
		this.ParentComponent = inputTypeComponent ;
	...
	let SearchWidget = function(inputTypeComponent, langSearch) {
		this.ParentComponent = inputTypeComponent ;
		this.IdCriteriaGroupe = this.ParentComponent.ParentComponent.parentCriteriaGroup.id ;
	...
	let BooleanWidget = function(inputTypeComponent, langSearch) {
		this.ParentComponent = inputTypeComponent ;
		this.IdCriteriaGroupe = this.ParentComponent.ParentComponent.parentCriteriaGroup.id ;
	...
	let NoWidget = function(inputTypeComponent) {
		this.html = null ;
	...
	let TreeWidget = function(inputTypeComponent, loaderHandler) {
